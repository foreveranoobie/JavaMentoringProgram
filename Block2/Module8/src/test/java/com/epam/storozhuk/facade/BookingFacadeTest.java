...
public class BookingFacadeTest {
    ...
    @BeforeEach
    public void init() {
        sut = new BookingFacadeImpl(userService, eventService, ticketService, pdfGenerator);
    }
    ...
    public void shouldCreateNewTicket() {
        ...
        Ticket updatedReturnTicket = Ticket.builder()
                .userId(1L)
                .build();
        Mockito.when(ticketService.bookTicket(any(Ticket.class))).thenReturn(updatedReturnTicket);
