...
public class UserController {
    ...
    @PostMapping(value = "/refillBalance/{id}")
    public ModelAndView refillBalance(@PathVariable Long id, @RequestBody String amount) {
        userService.refillBalance(id, Float.parseFloat(amount));
